...
class SerializerEstudanteTesteCase(TestCase):
    def setUp(self):
    ...
    def test_verifica_campos_serializados_de_estudante(self):
        ...
        self.assertEqual(dados.keys(), set(['id','nome','email','cpf','data_nascimento','celular']))

    def test_verifica_conteudo_dos_campos_serializados_de_estudante(self):
        """Teste que verifica o conteúdo dos campos que estão sendo serializados de estudantes"""
        dados = self.serializer_estudante.data
